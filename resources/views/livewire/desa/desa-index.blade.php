...
<h1 class="text-3xl text-black pb-6">Data Desa di Provinsi Bali</h1>
    ...
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <div>
                ...
                <div>
                    @if($statusEdit)
                    <livewire:desa.desa-update> </livewire:desa.desa-update>

                    @else
                    <livewire:desa.desa-create> </livewire:desa.desa-create>
                    @endif
                </div>
